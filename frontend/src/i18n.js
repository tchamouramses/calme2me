  ...
  en: {
    translation: {
      ...
      tabs: {
        ...
        rejectionProblem: 'Probleme',
        rejectionReason: 'Raison',
        rejectionIp: 'IP',
        rejectionDate: 'Date',
        rejectionLink: 'Lien probleme',
        rejectionDetails: 'Message rejete',
        viewDetails: 'Voir details',
        suspend: 'Suspendre',
        suspendTitle: 'Suspendre utilisateur',
        suspendSubtitle: 'Choisissez la duree de suspension pour cette IP.',
        suspendOneMonth: '1 mois',
        suspendSixMonths: '6 mois',
        suspendLifetime: 'A vie',
        suspendCustom: 'Duree personnalisee',
        suspendApply: 'Appliquer la suspension',
        suspendMonthsPlaceholder: 'Mois',
        suspendSuccess: 'Suspension appliquee.',
        suspendFailed: 'Impossible de suspendre l\'utilisateur.',
        suspendCustomInvalid: 'Veuillez saisir un nombre de mois valide.',
      ...
      admin: {
        ...
        rejectionDetails: 'Rejected message',
        viewDetails: 'View details',
        suspend: 'Suspend',
        suspendTitle: 'Suspend user',
        suspendSubtitle: 'Choose how long this IP should be suspended from posting.',
        suspendOneMonth: '1 month',
        suspendSixMonths: '6 months',
        suspendLifetime: 'Lifetime',
        suspendCustom: 'Custom duration',
        suspendApply: 'Apply suspension',
        suspendMonthsPlaceholder: 'Months',
        suspendSuccess: 'Suspension applied.',
        suspendFailed: 'Unable to suspend user.',
        suspendCustomInvalid: 'Please enter a valid number of months.',
